        ...
        <?php
                if(isset($_GET['redirect'])) {
                    ...
                    switch($redirect) {
                        ...
                        case 'gioi_thieu': include_once('Views/Client/gioithieu.php');break;
                        case 'thietke_noithat': include_once('Views/Client/tknt.php');break;
                        case 'bo_suu_tap': include_once('Views/Client/bst.php');break;
                        case 'success': include_once('Views/Client/success.php');break;
                    }
                }else {
